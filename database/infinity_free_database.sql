-- ==========================================================
-- Banco de Dados Completo para Aurora MMORPG
-- Otimizado para MySQL / Infinity Free
-- Banco: if0_41884898_aurorarpg
-- ==========================================================
...
('Espada de Madeira', 'Uma espada frágil de treinamento.', 'weapon', 'common', 50, 10, 2, 0, 0, 0, 0, 0, 0),
('Arco Curto', 'Um arco leve.', 'weapon', 'common', 50, 10, 0, 2, 0, 0, 0, 0, 0),
('Cajado Velho', 'Um cajado gasto pelo tempo.', 'weapon', 'common', 50, 10, 0, 0, 2, 0, 0, 0, 0),
('Poção Menor de HP', 'Recupera 50 de HP.', 'potion', 'common', 20, 5, 0, 0, 0, 0, 50, 0, 1),
('Couro de Lobo', 'Material útil para criação de itens.', 'material', 'common', 0, 5, 0, 0, 0, 0, 0, 0, 1);
